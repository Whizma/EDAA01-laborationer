...
class BSTTest {
	...
	void testHeightString() {
		...
		assertTrue(myStringBinarySearchTree.add("Boube"));
	...
	void testAddInt() {
		...
		System.out.print("Utskrift av heltal inorder");
	...
	void testAddString() {
		...
		assertTrue(myStringBinarySearchTree.root.left.element.equals("Boube"));
		System.out.print("Utskrift av strängar inorder");
